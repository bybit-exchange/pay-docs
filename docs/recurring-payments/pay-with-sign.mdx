...
| sign_params.single_limit.chain | string | No | Chain network (optional for cryptocurrency, e.g., BSC, TRX, ARBI, LTC, SOL, ETH, TON, APTOS) |
...
| sign_params.period_limits[].chain | string | No | Chain network (optional for cryptocurrency, e.g., BSC, TRX, ARBI, LTC, SOL, ETH, TON, APTOS) |
...
| pay_params.amount.chain | string | No | Chain network (required for crypto, e.g., BSC, TRX, ARBI, LTC, SOL, ETH, TON, APTOS) |
...
| result.pay_result.crypto_payment.chain | string | Chain network (e.g., BSC, TRX, ARBI, LTC, SOL, ETH, TON, APTOS) |
