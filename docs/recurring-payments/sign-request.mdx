...
| single_limit.chain | string | No | Chain network (for crypto, e.g., BSC, TRX, ARBI, LTC, SOL, ETH, TON, APTOS) |
...
| period_limits[].chain | string | No | Chain network (e.g., BSC, TRX, ARBI, LTC, SOL, ETH, TON, APTOS) |
